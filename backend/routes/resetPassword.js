...
router.post("/forgot-password", async (req, res) => {
  try {
    ...
    // DEBUG: log token and expiry so developer can verify the emailed token matches DB
    console.log(`🔐 Generated faculty reset token: ${resetToken}`);
    console.log(`⌛ Reset token expires at: ${new Date(resetPasswordExpires).toISOString()}`);
